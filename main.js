...
const scrollReducedMotion = window.matchMedia(
...
document.querySelectorAll('a[href^="#"]').forEach(anchor => {
    ...
    anchor.addEventListener("click", function (e) {
        ...
        */
        ...
        window.scrollTo({
            top: targetPosition,
            behavior: scrollReducedMotion ? "auto" : "smooth"
        });
...
/*====================================
    CONTACT FORM
    No backend on a static site, so this
    opens a pre-filled email to the address
    already shown in the Contact section
...
if (contactForm) {
    ...
    contactForm.addEventListener("submit", (e) => {
        ...
        const mailto =
            `mailto:abdulshariq345@email.com?subject=${subject}&body=${body}`;
